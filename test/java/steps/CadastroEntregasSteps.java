...
public class CadastroEntregasSteps {
    ...
    // Lê os dados da entrega e configura o modelo usando o serviço
    ...
    // Responsável por enviar a requisição para o endpoint de cadastro de entregas
    ...
    // Verifica se o código de status da resposta da API corresponde ao valor esperado fornecido pelo cenário de teste
