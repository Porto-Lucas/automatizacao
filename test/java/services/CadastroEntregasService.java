// Este arquivo é responsável por encapsular a lógica de negócios
// camada final entre a lógica de teste e o código da aplicação
...
public class CadastroEntregasService {
    ...
    // Ajusta os campos do objeto entregaModel com base nos parâmetros fornecidos
    public void setFieldsDelivery(String field, String value) {
        switch (field) {
            ...
            default -> throw new IllegalStateException("Unexpected feld" + field);// Um campo inesperado foi fornecido
        }
    }

    // Responsável por enviar uma requisição POST para a API
    ...
    // Declare a variável que armazena o ID da entrega
    ...
    // Responsável por Deletar item pelo ID
    ...
    // Responsável por carregar o Json Schema a partir de um arquivo especificado pelo filePath
